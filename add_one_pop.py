...
cur.execute("SELECT id FROM oyun WHERE baslik = 'Türkçe Pop: 5 Saniye Challenge' LIMIT 1")
oyun_id = cur.fetchone()[0]

song = {"query": "Demet Akalin Turkan", "correct": "Demet Akalın - Türkan", "wrong": ["Hadise - Şampiyon", "Gülşen - Dan Dan", "Hande Yener - Romeo"]}
idx = 10
